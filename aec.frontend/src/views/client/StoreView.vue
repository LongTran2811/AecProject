...
import SearchCompoment from '@/components/client/SearchCompoment.vue'
import ProductCarouselCompoment from '@/components/client/TimedCarouselComponent.vue'
import { ref } from 'vue'
...
<template>
  <div>
    ...
    <div>
      <ProductCarouselCompoment :dataNews="list" :itemsPerPage="5" />
    </div>
    <div>
      <ProductCompoment title="Sản phẩm mới nhất" :items="list" />
    </div>
  </div>
</template>
